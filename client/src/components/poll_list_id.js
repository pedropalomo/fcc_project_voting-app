...
import { fetchPollsById } from '../actions/index';
import { Link } from 'react-router';

class PollListID extends Component {
    
     componentWillMount() {
      this.props.fetchPollsById(this.props.params.id);
    }
...
export default connect(mapStateToProps, { fetchPollsById })(PollListID);
